    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="<?php echo e(route('admin.locationreservations.index')); ?>"
            ...
            <div class="m-2 p-2 bg-slate-100 rounded flex justify-center">
                <div class="space-y-8 divide-y divide-gray-200 w-full lg:w-1/2 mt-10">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.locationreservations.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="sm:col-span-6">
                            <label for="first_name" class="block text-sm font-medium text-gray-700"> Full Name </label>
                            <div class="mt-1">
                                <input type="text" id="first_name" name="name" value="<?php echo e(old('name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="tel_number" name="tel_number" value="<?php echo e(old('tel_number')); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="res_date" name="checkout_date"
                                    value="<?php echo e(old('checkout_date')); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="guest_number" name="guest_number"
                                    value="<?php echo e(old('guest_number')); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                                ...
                                <select id="location_id" name="location_id" class="form-multiselect block w-full mt-1">
                                    ...
                                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($location->id); ?>">
                                            <?php echo e($location->name); ?> (Total Capacity: <?php echo e($totalCapacity); ?> Guests)
                                        </option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="status" class="block text-sm font-medium text-gray-700">Set As
                                Recurring</label>
                            <div class="mt-1">
                                <input type="checkbox" id="recurring" name="recurring" value="<?php echo e(old('recurring')); ?>"
...
<?php /**PATH /home/glmokehj/public_html/resources/views/admin/locationReservations/create.blade.php ENDPATH**/ ?>