...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->endSlot(); ?>
    <h1 class="text-gray-500 dark:text-white font-bold">Table Reservation Report</h1>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-wrap justify-end gap-4 ">
                <?php if($search == '1'): ?>
                    <a href="<?php echo e(route('admin.reservations.history')); ?>"
                        class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white">Close Search</a>
                <?php endif; ?>
                <form action="<?php echo e(route('admin.reservations.history.search')); ?>" method="POST" class="mr-12">
                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                        <div
                            ...
                            <table id='TableReservationsHistory' class="min-w-full display pt-2">
...
<script>
    $(document).ready(function() {
        ...
        $('#TableReservationsHistory').DataTable({
            "order": [
                [2, "asc"]
...
<?php /**PATH /home/glmokehj/public_html/resources/views/admin/reservations/reservationHistory.blade.php ENDPATH**/ ?>