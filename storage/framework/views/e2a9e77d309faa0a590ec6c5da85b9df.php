        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center items-center m-2 p-2 gap-4">
                ...
                <span class="flex flex-col justify-center items-center m-2 p-2 ">
                    ...
                    <button onclick="alert('Qr data hasn\'t been hosted yet!') ; alert('Please contact the developer for hosting plans.')"
...
<?php endif; ?>
<?php /**PATH /home/glmokehj/public_html/resources/views/admin/menus/index.blade.php ENDPATH**/ ?>