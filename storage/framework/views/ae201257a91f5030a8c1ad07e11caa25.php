                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="morning" class="hidden peer" name="time_period"
                                value="morning">
                            <label for="morning"
                                class="flex items-center justify-center w-8 h-8 border-2 border-gray-700 dark:border-gray-300 bg-gray-200  rounded-lg cursor-pointer peer-checked:bg-red-500 peer-checked:border-emerald-500 transition duration-200 ease-in-out">
                ...
                <div class=" w-full flex justify-between items-center">
                    <div class="flex">
                        <div class="flex items-center mr-4 ">
                            <div class="h-6 w-6 rounded-full bg-emerald-400 mr-2"></div>
                            <div class="dark:text-white ml-2">Available</div>
                        </div>
                        <div class="flex items-center ml-2">
                            <div class="h-6 w-6 rounded-full bg-red-500 mr-2"></div>
...
$reservationOverlap = false;
                                ...
                                echo $reservationOverlap ? 'bg-red-500 hover:bg-red-700' : 'bg-emerald-400 hover:bg-emerald-700'; ?>
...
$reservationOverlapTables = false;
                              ...
                              foreach ($AreaReservations as $reservation) {
                                ...
                                echo $reservationOverlapTables || $reservationOverlapAreas ? 'bg-red-500 hover:bg-red-700' : 'bg-emerald-400 hover:bg-emerald-700'; ?>
                                shadow-lg text-white"
                                style="height:60px; width:100px">
                                <strong><?php echo e($table->name); ?></strong>
                            </span>
...
<?php /**PATH C:\Users\Admin\Desktop\Mesh\ReservationsMS\resources\views/admin/index.blade.php ENDPATH**/ ?>