...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <a href="<?php echo e(route('admin.users.create')); ?>"
            class="bg-indigo-500 text-white px-4 py-2 rounded-lg mb-4 inline-block">Add
            User</a>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="border p-2">
                            <a href="<?php echo e(route('admin.users.show', $user->id)); ?>"
                                class="bg-indigo-500 text-white px-4 py-2 rounded-lg">View</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Downloads\reservation\resources\views/admin/users/index.blade.php ENDPATH**/ ?>