...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->endSlot(); ?>
    <h1 class="text-gray-500 dark:text-white font-bold">Locations Reservation List</h1>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-wrap justify-end gap-2 m-2 p-2">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.locationreservations.search')); ?>" method="POST" class="mr-12">
                ...
                <a href="<?php echo e(route('admin.locationreservations.create')); ?>"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">New Area
                    Reservation</a>
            </div>
                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                        <div
                            ...
                            <table id='LocationReservations' class="min-w-full display pt-2">
...
<script>
    $(document).ready(function() {
        ...
        $('#LocationReservations').DataTable({
            "order": [
                [2, "asc"]
...
<?php /**PATH C:\Users\Admin\Downloads\reservation\resources\views/admin/locationReservations/index.blade.php ENDPATH**/ ?>