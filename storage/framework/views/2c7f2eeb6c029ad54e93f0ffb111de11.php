        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="<?php echo e(route('admin.tables.index')); ?>"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Tables List</a>
            </div>
...
<?php endif; ?><?php /**PATH /home/glmokehj/public_html/resources/views/admin/tables/edit.blade.php ENDPATH**/ ?>