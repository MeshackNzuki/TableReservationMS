        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded flex justify-center">
                <div class="space-y-8 divide-y divide-gray-200 w-full lg:w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.locationreservations.update', $reservation->id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="first_name" name="name"
                                    value="<?php echo e(old('first_name', $reservation->user->name)); ?>"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" id="email" name="email"
                                    value="<?php echo e($reservation->user->email); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="tel_number" name="tel_number"
                                    value="<?php echo e($reservation->user->tel_number); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
...
<?php /**PATH C:\Users\Admin\Downloads\reservation\resources\views/admin/locationReservations/edit.blade.php ENDPATH**/ ?>