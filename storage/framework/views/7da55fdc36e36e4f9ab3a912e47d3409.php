...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Welcome To Rollingstones</span>
        </h1>
        <div class="mx-auto mt-2 text-emerald-50 md:text-center lg:text-lg">
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <h2 class="text-4xl text-emerald-600">Welcome</h2>
                        <!-- </h1> -->
                        ...
                        <div class="relative flex">
                            <a href="#_"
                                class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-emerald-600 rounded-md sm:mb-0 hover:bg-emerald-700 sm:w-auto">
                                Read More
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="<?php echo e(asset('images/people-2576336_960_720.jpg')); ?>" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <h2
                            class="mb-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">
                            WHY CHOOSE US?</h2>
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="<?php echo e(asset('images/Free Vector _ People sitting at the cafe.jpeg')); ?>" alt="feature image">
                </div>
            </div>
        </div>
    </section>
    <?php if(is_array($specials)): ?>
        <section class="mt-8 bg-white">
            <div class="mt-4 text-center">
                <h3 class="text-2xl font-bold">Our Menu</h3>
                <h2
                    class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        <div class="my-16 text-center">
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">
                Testimonial </h2>
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-emerald-500 rounded-full"
                        src="<?php echo e(asset('images/Casual businessman at office.jpeg')); ?>">
                </div>
                <div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-emerald-500">John Doe</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-emerald-500 rounded-full"
                        src="<?php echo e(asset('images/young-3061652__340.jpg')); ?>">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-emerald-500 rounded-full"
                        src="<?php echo e(asset('images/purchase-3090818__340.jpg')); ?>">
                </div>
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Food</h2>
                    <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores
...
<?php endif; ?>
<?php /**PATH C:\Users\meshk\OneDrive\Desktop\Mesh\Gozerolabs\TableReservationMS\resources\views/welcome.blade.php ENDPATH**/ ?>