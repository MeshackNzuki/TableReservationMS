        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.menus.update', $menu->id)); ?>"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" name="name" value="<?php echo e($menu->name); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                <img class="w-32 h-32" src="<?php echo e(Storage::url($menu->image)); ?>">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000.00" step="0.01" id="price"
                                    name="price" value="<?php echo e($menu->price); ?>"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Desktop\Mesh\ReservationsMS\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>