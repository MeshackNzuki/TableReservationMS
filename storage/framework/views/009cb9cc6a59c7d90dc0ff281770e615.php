...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <?php if($search == '1'): ?>
            <a href="<?php echo e(route('admin.locationreservations.history')); ?>"
                class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white">Close Search</a>
        <?php endif; ?>
        <form action="<?php echo e(route('admin.locationreservations.history.search')); ?>" method="POST" class="mr-12">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/glmokehj/public_html/resources/views/admin/locationReservations/reservationHistory.blade.php ENDPATH**/ ?>