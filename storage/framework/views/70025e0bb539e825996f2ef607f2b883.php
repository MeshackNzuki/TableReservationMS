    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center items-center m-2 p-2 gap-4">
                ...
                <span class="flex flex-col justify-center items-center m-2 p-2 ">
                    ...
                    <button onclick="printDiv()"
                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Print Qr Menu
                        Code
                    </button>
                </span>
            </div>
            <div class="flex justify-end m-2 p-2 gap-4">
                ...
                <a onclick="alert('This module is ready. Please contact system developer for activation so you can add menu items')"
    ...
    <script>
        function printDiv() {
            ...
            document.getElementById('print-area-text').innerHTML = `
                ...
                <p class="text-lg text-gray-600">Scan the QR code to view our full Menu.</p>
            `;
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Desktop\Mesh\ReservationsMS\resources\views/admin/menus/index.blade.php ENDPATH**/ ?>