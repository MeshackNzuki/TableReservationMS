...
$reservationOverlap = false;
                                ...
                                echo $reservationOverlap ? 'bg-red-500 hover:bg-red-700' : 'bg-emerald-400 hover:bg-emerald-700'; @endphp
...
$reservationOverlapTables = false;
                              ...
                              foreach ($AreaReservations as $reservation) {
                                ...
                                echo $reservationOverlapTables || $reservationOverlapAreas ? 'bg-red-500 hover:bg-red-700' : 'bg-emerald-400 hover:bg-emerald-700'; @endphp
                                shadow-lg text-white"
                                style="height:60px; width:100px">
                                <strong>{{ $table->name }}</strong>
                            </span>
